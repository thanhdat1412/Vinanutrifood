		...
		<form method="post" action="">
				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php esc_html_e( 'Nếu tồn tại một tài khoản khớp với các chi tiết được cung cấp, chúng tôi sẽ gửi liên kết đặt lại mật khẩu. Hãy kiểm tra hộp thư đến của bạn.', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } elseif ( isset( $_GET['updated'] ) && 'password_changed' === sanitize_key( $_GET['updated'] ) ) { ?>
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php esc_html_e( 'Bạn đã thay đổi mật khẩu thành công.', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } else { ?>
						...
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php if ( 'expiredkey' === sanitize_key( $_GET['updated'] ) ) {
									esc_html_e( 'Liên kết đặt lại mật khẩu của bạn đã hết hạn. Vui lòng yêu cầu một liên kết mới dưới đây.', 'ultimate-member' );
								} elseif ( 'invalidkey' === sanitize_key( $_GET['updated'] ) ) {
									esc_html_e( 'Liên kết đặt lại mật khẩu của bạn dường như không hợp lệ. Vui lòng yêu cầu một liên kết mới dưới đây.', 'ultimate-member' );
								} ?>
							</div>
						</div>
					</div>
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php esc_html_e( 'Để đặt lại mật khẩu của bạn, vui lòng nhập địa chỉ email hoặc tên người dùng của bạn bên dưới.', 'ultimate-member' ); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e( 'ĐẶT LẠI MẬT KHẨU', 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
